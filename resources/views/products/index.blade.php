      ...
      <div class="container">
        ...
        <form method="GET" action="/products" class="toolbar">
          <div class="search-area">
            <input type="text" name="search" placeholder="Cari produk, kategori, atau toko..." value="{{ request('search') }}" />
          </div>
          ...
          <div class="toolbar-controls">
            ...
            <select name="sort">
              ...
              <option value="Rating Tertinggi" {{ request('sort') == 'Rating Tertinggi' ? 'selected' : '' }}>Rating Tertinggi</option>
            </select>
            ...
            @forelse($products as $product)
              <article class="product-card">
                ...
                <div class="product-body">
                  ...
                  <p class="meta">⭐ {{ $product->rating }} · {{ $product->stock > 0 ? 'Stok tersedia' : 'Stok habis' }}</p>
                  <div class="price-row">
                    <h4>Rp{{ number_format($product->price, 0, ',', '.') }}</h4>
                    <span>{{ $product->location }}</span>
                  </div>
                  <div class="product-buttons">
                    <a href="/products/{{ $product->id }}" class="btn btn-outline">Lihat Detail</a>
